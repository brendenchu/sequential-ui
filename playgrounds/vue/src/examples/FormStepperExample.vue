<template>
  <div>
    ...
    >
      <template
        #panel="{ panel, index, isFirst, isLast, next, previous, canGoNext, canGoPrevious }"
      >
        <div class="p-6">
          <!-- Step Header -->
          <div class="mb-6">
              ...
              <div class="flex items-center">
                <div class="flex items-center">
                  ...
                  <h3 class="ml-3 text-lg font-medium text-gray-900">
                    {{ (panel as FormPanelDefinition)?.title || 'Step' }}
                  </h3>
                </div>
              </div>
            </div>
            <p class="text-gray-600">{{ (panel as FormPanelDefinition)?.description || '' }}</p>
          </div>
    ...
    <div class="mt-6 p-4 bg-gray-100 rounded-lg">
      ...
      <div class="text-sm text-gray-600 space-y-1">
        ...
        <div><strong>Current Step:</strong> {{ currentStep + 1 }} of {{ formPanels.length }}</div>
